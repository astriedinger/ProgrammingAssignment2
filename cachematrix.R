...
## This was the simplest way I found to solve the assigment. The two functions below will make a matrix, and cache its inverse
## The invers is calculated, and if the inverse is needed again, the value will be read and given from the cache =)
